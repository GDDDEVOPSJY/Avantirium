...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">	
            ...
            <div class="col-md-10">
            <form name="enquiry" method="post" action="qualificationform.php">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-12 mb-3">
                    <select class="custom-select form" name="country" id="exampleFormControlSelect1" required>
                ...
                <div class="col-md-6 col-sm-6 col-12 mb-3">
                    <select class="custom-select form" name="state" id="exampleFormControlSelect1" required>
                ...
                <div class="col-md-12 col-sm-12 col-12 mb-3">
                    <select class="custom-select form" name="industry"  id="exampleFormControlSelect1" required>
                ...
                <div class="col-md-12 col-sm-12 col-12 mb-3">
                    ...
                    <label class="custom-control-label" name="focus[]" id="" for="vmarket3">Automotive</label>
                    </div>
                    <div class="custom-control custom-checkbox mt-1">
