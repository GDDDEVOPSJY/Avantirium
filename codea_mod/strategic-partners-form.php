    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="ai-head">
                ...
                <h1>Become a Strategic Partner</h1>
        ...
        <div class="row">	
            ...
            <div class="col-md-10">
            <form name="enquiry" method="post" action="strategic-form-send.php">
            <div class="row">
       ...
       $('#country').on('change', function() {
        ...
        <?php if(isset($_SESSION['message'])): ?>
            <?php if($_SESSION['message']['status']==true): ?>
                alert('Thank you for your interest in Strategic partnership. We will get back to in 2 business days');
            <?php else: ?>
