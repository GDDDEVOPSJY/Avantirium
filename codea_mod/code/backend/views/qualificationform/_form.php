...
<div class="usedcars-form">
    ...
    <div class="tab-content">
        <div id="tab-general" class="tab-pane active">
			  ...
			  <?= $form->field($model, 'partnership_category')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'mobile')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'website')->textInput(['maxlength' => true]) ?>			  
			  <?= $form->field($model, 'skype')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'email')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'solution')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'main_goal')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'current_business')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'constitute')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'services')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'service_country')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'no_of_officers')->textInput(['maxlength' => true]) ?>
			  <?= $form->field($model, 'no_of_customers')->textInput(['maxlength' => true]) ?>
