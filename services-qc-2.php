                ...
                <div class="col-md-12">
                    <div class="block text-center">
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="services.php" class="text-white">QC Services</a></li>
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="#" class="text-white-50">Mortgage Prefund QC Audit Services</a></li>
                        </ul>
                    </div>
                </div>
            </div>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse3"> 
							  > Underwriting Quality Review</a></h4>
						  </div>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse4"> 
							  > Appraisal Desk Reviews</a></h4>
						  </div>
						  <div id="collapse4" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">Appraisal desk reviews are a commonly used procedure in the pre-fund audit process. It is used to critique the mortgage appraisal process. As a premium Pre-Fund QC audit and mortgage quality control company, our appraisal desk review service identifies flaws with the appraisal process. Our appraisal review desk will ensure at all costs that the mortgage loan amount funded never exceeds the actual value of the property.</p>
							</div>
						  </div>
						</div>
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse5"> 
							  > Federal and State Regulatory Compliance</a></h4>
						  </div>
