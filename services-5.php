...
<div class="main-wrapper ">
    <section class="page-title bg-services-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-4 text-lg">Mortgage Closing Support Services</h1>
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="#" class="text-white-50">Mortgage Closing Support Services</a></li>
                        </ul>
                    </div>
                </div>
            </div>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse3"> 
							  > Preparing Closing Instructions Statement</a></h4>
						  </div>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse4"> 
							  > Working with Settlement Companies</a></h4>
						  </div>
						  <div id="collapse4" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">We work on your behalf with settlement companies to evaluate taxes and fees and procure the escrow agreement. We also pass on lender instructions to settlement agents to determine how the mortgage funds are distributed at mortgage loan closing.
                                <ul>
                                    <li>Reach out to settlement companies for fee sheets</li>
                                    <li>Obtain the escrow agreement</li>
                                    <li>Evaluate taxes and fees</li>
							...
							<div class="panel-body">
                              ...
                              <p>Our Closing Service Steps:</p>
                                <ul>
                                    ...
                                    <li>Examine Title</li>
                                    <li>Tax, insurance & reserve audits</li>
                                    <li>Preparation of statutory statements and deed</li>
                                    <li>Review all open conditions and ensure all underwriting conditions are signed off on</li>
                                    <li>Submit loan package to lender and clear lender conditions</li>
                                    <li>Contact hazard insurance company to obtain new mortgagee clause</li>
                                    <li>Prepare the document order form and fee sheet and fax to the Loan Officer for approval</li>
                                    <li>Fax approved documents to the appropriate lender</li>
                                    <li>Prepare the Prelim HUDs (settlement statements) and Final HUDs based on the Closing Instructions/Fee Sheets/Invoices</li>
                                    <li>Obtain closing protection letters and wiring instructions</li>
                                    <li>Change the loss payee clause on the approved file</li>
                                </ul>
                              </p><br>
							</div>
						  </div>
