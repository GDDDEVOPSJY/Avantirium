            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-4 text-lg">Mortgage Underwriting QC Services</h1>
...
<section class="section service border-top bg-gray">
	<div class="container">
		...
		<h2>Mortgage Underwriting QC Services</h2>
							
		
        <p>Aventirium has over a decade  of experience in providing robust back office support for lenders with Underwriting QC services. Our services consists of engaging your experts with your underwriting process to review the final underwriting decision in detail. From evaluating the conditions provided by the underwriter to the accuracy checking process of the loan decision, we enable lenders to establish a much needed QC protocol to regulate the quality of their underwriting process.</p>
        <p>As a premium mortgage underwriting QC services company we analyze the income and liabilities included in the loan package to ensure that the debt and income figures utilized by the underwriter are accurate. Our services ensure that your loan portfolios adhere to all GSE regulations and guidelines at the pre-closing and the post-closing stages. Outsource Mortgage Underwriting QC services to us to give your loan approval process the protection it needs from risks.</p>


        <h3>Our Comprehensive Mortgage Underwriting QC Services</h3><br/><br/>
				<div class="panel-group col-12">
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
							...
							<div id="collapse1" class="collapse">
								<div class="panel-body"><p class="text-justify">Our pre-funding QC services are designed to identify and address defects in the loan, prior to its closing. We review a predetermined percentage of loans and examine them in detail to validate the loan selection process as well as the data and documents that are a part of the loan portfolio. From the review of data entered into an automated underwriting system to the verification of borrower social security number, income statements, we ensure that all supporting documents are present with complete information.</p></br>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse2"> 
							  > Post Funding QC</a></h4>
						  </div>
						  <div id="collapse2" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">We review the loan to assess the accuracy and integrity of the information that was used to support the underwriting decision. We assess the completion of the loan application, underwriting documents, property eligibility, reports generated from third-party data analysis tools and the mortgage insurer. Our post-funding QC services is a vital aspect of establishing well-rounded underwriting QC parameters.</p></br>
							</div>
						  </div>
						</div>
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  ...
						  <div id="collapse4" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">We use diligent fraud review measures to scout for discrepancies in mandatory loan information. This includes conflicting addresses, AVM comps mismatching with the property, multiple cash transactions and large deposits or withdrawals. We identify all missing links that may affect the loan approval process as a part of our fraud review services.</p></br>
							</div>
						  </div>
						</div><br/>
						
                        <h3>Why Outsource Mortgage Underwriting QC Services To Aventirium?</h3>
                        <p>We are a global mortgage underwriting QC services company with vast and varied experience in performing validations, document verifications and error reporting. Our services enable you to re-confirm the loan decision by verifying that the credit, capacity, collateral and capital figures are accurately represented to deliver a fair and well-informed mortgage decision. Our team of experts have an immense process and technical knowledge. We use state of the art software suites to validate and verify property, customers, credit check and property appraisal reports. A thorough review of the loan portfolio enables you to determine the quality of the underwriting process, before finally making the decision to package the loan and dispatch it to closing.</p>
