				...
				<div class="row">
					<div class="col-md-12">
						<div class="block text-center">
							<h1 class="text-capitalize mb-4 text-lg">Avantirium Business Solutions</h1>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="about-item pr-3 mb-5 mb-lg-0">
							<h2 class="mt-3 mb-4 position-relative content-title">We are a dedicated team of mortgage processing.</h2>
							<p>A company formed by professionals with decades of experience in the mortgage industry, commits itself to making mortgage process outsourcing faster, easier, better and more economical than ever before.
