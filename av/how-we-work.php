					...
					<div class="col-md-12">
						<div class="block text-center">
							...
							<ul class="list-inline">
								...
								<li class="list-inline-item"><a href="#" class="text-white-50">How We Work</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					<p>When you outsource mortgage processing, you want to make sure of a number of things. One, you want to know that the team is thorough with each dotted I and crossed T.
						...
						That means a bulletproof process every step of the way. Our 6 Step Mortgage Process demonstrates each of these concerns.</p>
				</div>
