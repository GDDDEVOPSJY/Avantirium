                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <form id="contact-form" method="post" action="mail.php">
                            ...
                            <input class="btn btn-main" name="submit" type="submit" value="Send Message" />
                        </form>
                    </div>
                    ...
                    <div class="col-lg-5 col-sm-12">
                        <div class="contact-content pl-lg-5 mt-5 mt-lg-0">
                            ...
                            <ul class="address-block list-unstyled">
                                <li>
                                    <i class="ti-direction mr-3"></i>13520 Mason Canyon Lane, Pearland, Texas 77584
                                </li>
                                <li>
                                    <i class="ti-email mr-3"></i>Email: info@avintiriumsolutions.us
                                </li>
                                <li>
                                    <i class="ti-mobile mr-3"></i>Phone: +1 356-677-5555
                                </li>
                            </ul>
