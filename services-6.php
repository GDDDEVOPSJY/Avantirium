            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-4 text-lg">Mortgage Loan Modification And Origination Services</h1>
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="#" class="text-white-50">Mortgage Loan Modification And Origination Services</a></li>
                        </ul>
                    </div>
                </div>
            </div>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
							<div class="panel-heading">
								<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse1"> 
								  > Our Mortgage Loan Modification And Origination Services</a></h4>
							</div>
							<div id="collapse1" class="collapse">
								<div class="panel-body"><p class="text-justify"><b>We carry out the complete back-office support needs of the lender to process loan modification requirements. Some of these tasks include:</b>
 
                                </p>
								 <ul>
                                    <li>Pre-review and recommend program eligibility to borrowers on behalf of lenders.</li>
                                    <li>Collect, review and submit relevant documents to underwriter. These include letters of explanation, additional bank statements, additional pay stubs, verification letters etc.</li>
                                    <li>Review the terms of the new mortgage conditions prepared by the underwriter for consistency.</li>
                                 </ul>	
								</div>
							</div>
						</div>
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse2"> 
							  > Mortgage Modification Underwriting Services (HAMP/Non-HAMP)</a></h4>
						  </div>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse4"> 
							  > Mortgage Origination Underwriting Services</a></h4>
						  </div>
							...
							<div class="panel-body">
							  <p class="text-justify">
                                <ul>
                                    ...
                                    <li>Initial underwriting QC to check accuracy followed by automated underwriting tool check</li>
                                    <li>Assess borrower risk profile and determine the appropriate risk class</li>
                                    <li>Compute loan-to-value ratio, debt-to-income ratio, credit ratio etc</li>
                                    <li>Property appraisal to determine its value as a loan collateral</li>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse5"> 
							  > How We Make Modification And Origination Services Efficient And Accurate</a></h4>
						  </div>
							  ...
							  <p class="text-justify">Mortgage modification program is an important process for lenders and need the touch of experience to overcome the complicacies. This is more important at a time when there is increase in the number of distressed borrowers looking for loan modification, and lenders are burdened with the extra work to modify loans in order to avert losses. As an experienced mortgage modification and origination underwriting company, we have the expertise needed to provide reliable support to meet modification underwriting requirements and customer expectations cost effectively.
                               ...
                               We help our clients:
                                <ul>
                                    ...
                                    <li>Avail in-house staff for business development and customer retention activities that require personalized attention</li>
                                    <li>Get the modification and origination underwriting changes go through a series of audits to ensure highest level of accuracy</li>
