            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-4 text-lg">Title Support Services</h1>
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="#" class="text-white-50">Title Support Services</a></li>
                        </ul>
                    </div>
                </div>
            </div>
				...
				<div class="panel-group col-12">
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
							...
							<div id="collapse1" class="collapse">
								<div class="panel-body"><p class="text-justify">As part of the process we get the details of the mortgage title or settlement company from the Loan Officer and order the Title for the property in consideration. Next, we follow up with the title company until we receive the Title and Title report.</p><br>
								 <ul>
						  ...
						  <div id="collapse2" class="collapse">
							<div class="panel-body">
                              ...
                              <ul>
                                ...
                                <li>Analyze records, such as mortgages, liens, judgments, easements, vital statistics, and plat and map books, to determine ownership and legal restrictions</li>
                                <li>Verify legal description of property and completeness of records</li>
                                <li>Identify issues such as missing information, inaccurate information, or contradictory information contained in the title documentation</li>
                              </ul>
						  ...
						  <div id="collapse3" class="collapse">
							<div class="panel-body">
                              ...
                              <ul>
                                ...
                                <li>Uncover defects early on to help close transactions quickly</li>
                                <li>Capture essential data for commitment easement, tax status, and restrictions</li>
                                <li>Prepare title commitment according to the title report</li>
                              </ul>
							</div>
						  </div>
						</div>
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse4"> 
							  > Final Policy Production</a></h4>
						  </div>
						  <div id="collapse4" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">In the Final Title policy, we take care of generating Short Form, Long Form and Owner Policies in the client application, considering the exceptions and endorsements as provided in the title commitment report. We have experience working across multiple states and with various title companies. By outsourcing title support services and final policy work to us you not only save on per employee costs but also enable in-house staff to work on revenue generating activities and eliminate issues from arising with underwriters.
                                <ul>
                                    <li>Generate long form, short form, and owner policies</li>
                        ...
                        <div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse6"> 
							  > Settlement and Closing Services</a></h4>
						  </div>
						  <div id="collapse6" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">This is a critical part of our mortgage title services. With the help of closing services, you sign and exchange all the documents needed to convey title, secure your business, deal with collateral issues, and explain costs to stakeholders in an orderly manner. This process involves preparing a "HUD 1” or closing statement. It consists of the document preparation charges, mortgage lender’s charges, title company charges, recording charges, and the amount to be paid to release any existing mortgages, real estate commission fees, taxes, survey fees, and all other costs associated with the deal.
                                <ul>
                                    <li>Structure the signing and exchange of all documents in an orderly manner</li>
                        ...
                        <div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse7"> 
							  > Why Outsource Mortgage Title Support Service To Aventiriums</a></h4>
						  </div>
						  <div id="collapse7" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">Expert Mortgage Assistance offers lenders the best back-office support for mortgage title services. Whether your needs are small, or you are processing high volume files, we are well-equipped to help you manage your title requirements in a seamless and accurate fashion.
                              <p>By outsourcing mortgage title services process to us, you get the following benefits:</p>
                                <ul>
                                    <li>1000+ highly trained mortgage processors working full-time</li>
                                    <li>99% accuracy guaranteed in review of title documents for protection of lender’s interests (Title commitment, title examination, title insurance, etc.)</li>
                                    <li>Standardized and automated back-office support for mortgage title services</li>
                                    <li>Up to 30% reduction in TAT, leveraging a 24/7 work environment</li>
                                    <li>Up to 40% reduction in per employee operational cost</li>
                                    <li>Flexibility to scale work up by 50% during peak times</li>
