            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        <h1 class="text-capitalize mb-4 text-lg">Mortgage Post Closing Audit Services</h1>
                        <ul class="list-inline">
                            <li class="list-inline-item"><a href="index.php" class="text-white">Home</a></li>
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="services.php" class="text-white">Services</a></li>
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="services.php" class="text-white-50">Mortgage QC Services</a></li>
                            <li class="list-inline-item"><span class="text-white">/</span></li>
                            <li class="list-inline-item"><a href="#" class="text-white-50">Mortgage Post Closing Audit Services</a></li>
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse2"> 
							  > Risk and Data Integrity Analysis</a></h4>
						  </div>
						  <div id="collapse2" class="collapse">
							<div class="panel-body">
							  <p class="text-justify">We understand that the smallest of mistakes in recording data can lead to serious legal consequences. To help you avert such possibility, we have developed a multi-tier document verification system to ensure there is no compromise with data integrity. In case of any discrepancies, we flag it and recommend a review so that flawed assumptions can be rectified.</p></br>
							</div>
						  </div>
						</div>
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						...
						<div class="panel panel-default" style="padding: 0 0 20px 0;" id="parnt">
						  <div class="panel-heading">
							<h4 class="panel-title"><a data-toggle="collapse" data-parent="#parnt" href="#collapse5"> 
							  > Asset Re-Verification and Tax Transcripts</a></h4>
						  </div>
